...
export class DsedataService {
  ...
  get52WeekLowestData():Observable<Array<StockProfileDisplayModel>>{
    return this.httpClient.get<Array<StockProfileDisplayModel>>(this.apiUrl2+"/api/Stock/GetStocksNearLowestPrice");
  }
}
